            ...
            <div className="">
                <div className="max-w-[1240px] mx-auto grid md:grid-cols-5 gap-4 px-3 border-b pb-4">
                    <div className="border p-3">
                        <img className="w-48 h-[150px] rounded" src={tes} alt="" />
                        <div>
                    ...
                    <div className="border p-3">
                        <img className="w-48 h-[150px] rounded" src={tes2} alt="" />
                        <div>
                    ...
                    <div className="border p-3">
                        <img className="w-48 h-[150px] rounded" src={tes3} alt="" />
                        <div>
                    ...
                    <div className="border p-3">
                        <img className="w-48 h-[150px] rounded" src={tes4} alt="" />
                        <div>
                    ...
                    <div className="border p-3">
                        <img className="w-48 h-[150px] rounded" src={tes5} alt="" />
                        <div>
