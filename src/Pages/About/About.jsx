        ...
        <div className="mt-14 max-w-[1240px] mx-auto border-b py-4 mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6 px-3 md:mt-16 mt-8">
                ...
                <div className="mt-8">
                    ...
                    <Link to="/contact"><button className="bg-[#f3b160] text-white text-xl mt-10 w-full font-bold hover:bg-[#d69c54] duration-300 p-4 rounded-md"><span className="flex items-center justify-center gap-4"><BiSupport className="text-4xl text-red-500" /> <p>Contact NOW!</p> </span></button></Link>
                </div>
